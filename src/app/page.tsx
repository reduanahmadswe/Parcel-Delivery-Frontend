          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-200 text-sm leading-relaxed">
                Your trusted partner for fast, secure, and reliable parcel delivery services. 
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link href="/track" className="text-gray-200 hover:text-white transition-colors duration-200">
                    Package Tracking
                  </Link>
                </li>
                <li>
                  <Link href="/register" className="text-gray-200 hover:text-white transition-colors duration-200">
                    Express Delivery
                  </Link>
                </li>
                <li>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link href="/login" className="text-gray-200 hover:text-white transition-colors duration-200">
                    Login
                  </Link>
                </li>
                <li>
